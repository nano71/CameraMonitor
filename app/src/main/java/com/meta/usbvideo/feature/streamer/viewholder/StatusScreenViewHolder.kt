...
import com.meta.usbvideo.core.permission.CameraPermissionDenied
import com.meta.usbvideo.core.permission.CameraPermissionGranted
import com.meta.usbvideo.core.permission.CameraPermissionRequested
import com.meta.usbvideo.core.permission.CameraPermissionRequired
import com.meta.usbvideo.core.permission.CameraPermissionState
import com.meta.usbvideo.core.permission.RecordAudioPermissionDenied
import com.meta.usbvideo.core.permission.RecordAudioPermissionGranted
import com.meta.usbvideo.core.permission.RecordAudioPermissionRequested
import com.meta.usbvideo.core.permission.RecordAudioPermissionRequired
import com.meta.usbvideo.core.permission.RecordAudioPermissionState
import com.meta.usbvideo.core.usb.UsbDeviceState
import com.meta.usbvideo.core.usb.UsbMonitor
import com.meta.usbvideo.core.usb.UsbSpeed
...
class StatusScreenViewHolder(
    ...
    fun getUsbSpeedLabel(usbSpeed: UsbSpeed): String? {
        return when (usbSpeed) {
            ...
            UsbSpeed.Super -> context.getString(R.string.usb_speed_super)
            UsbSpeed.SuperPlus -> context.getString(R.string.usb_speed_super_plus)
        }
    }
}